...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About Us | ABC Building Contracting LLC UAE</title>
        <meta
          name="description"
          content="Learn about ABC Building Contracting LLC, a trusted UAE construction company delivering residential, commercial, and civil engineering projects with quality and safety excellence."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://abccont.com/about" />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://abccont.com/about" />
        <meta property="og:title" content="About ABC Building Contracting LLC" />
        <meta property="og:description" content="Professional construction company in UAE focused on quality, integrity, and timely project delivery." />
