    ...
    >
      ...
      <section className="relative py-20 bg-muted/30 mb-20">
        <div className="container mx-auto px-4 text-center">
          <SectionTitle title="About ApexBuild" subtitle="Who We Are" align="center" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Founded with a vision to revolutionize the construction industry, ApexBuild has grown from a small contractor to a full-service construction and manpower firm. Our journey is defined by a relentless pursuit of quality and a commitment to our clients' success.
            </p>
